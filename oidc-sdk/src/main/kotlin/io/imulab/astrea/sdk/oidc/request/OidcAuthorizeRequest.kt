...
class OidcAuthorizeRequest(
    client: io.imulab.astrea.sdk.oidc.client.OidcClient,
    ...
    val claims: io.imulab.astrea.sdk.oidc.claim.Claims,
    ...
    class Builder(
        var client: io.imulab.astrea.sdk.oidc.client.OidcClient? = null,
        ...
        var claims: io.imulab.astrea.sdk.oidc.claim.Claims = io.imulab.astrea.sdk.oidc.claim.Claims(),
