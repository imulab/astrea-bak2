...
class ClientDTO(
    ...
    fun buildClient(): Client {
        return Client(
            ...
            idTokenSignedResponseAlgorithm = JwtSigningAlgorithm.fromSpec(idTokenSignedResponseAlg),
            idTokenEncryptedResponseAlgorithm = JweKeyManagementAlgorithm.fromSpec(idTokenEncryptedResponseAlg),
            idTokenEncryptedResponseEncoding = JweContentEncodingAlgorithm.fromSpec(idTokenEncryptedResponseEnc),
            requestObjectSigningAlgorithm = JwtSigningAlgorithm.fromSpec(requestObjectSigningAlg),
            requestObjectEncryptionAlgorithm = JweKeyManagementAlgorithm.fromSpec(requestObjectEncryptionAlg),
            requestObjectEncryptionEncoding = JweContentEncodingAlgorithm.fromSpec(requestObjectEncryptionEnc),
            userInfoSignedResponseAlgorithm = JwtSigningAlgorithm.fromSpec(userInfoSignedResponseAlg),
            userInfoEncryptedResponseAlgorithm = JweKeyManagementAlgorithm.fromSpec(userInfoEncryptedResponseAlg),
            userInfoEncryptedResponseEncoding = JweContentEncodingAlgorithm.fromSpec(userInfoEncryptedResponseEnc),
